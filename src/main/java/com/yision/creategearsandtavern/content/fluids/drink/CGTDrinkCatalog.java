...
public final class CGTDrinkCatalog {
	...
	private static final List<CGTDrinkDefinition> DEFINITIONS = List.of(
		...
		new CGTDrinkDefinition(
			...
			0x695c63,
			List.of("twilightforest", "kaleidoscope_dim_wine")
		),
		new CGTDrinkDefinition(
		...
		new CGTDrinkDefinition(
			...
			0x7dab8a,
			List.of("the_bumblezone", "kaleidoscope_dim_wine")
		),
		new CGTDrinkDefinition(
		...
		new CGTDrinkDefinition(
			...
			0xc3d1d1,
			List.of("aether", "kaleidoscope_dim_wine")
		),
		new CGTDrinkDefinition(
		...
		new CGTDrinkDefinition(
			...
			0x8a0e20,
			List.of("kaleidoscope_bloodwine")
		),
		new CGTDrinkDefinition(
		...
		new CGTDrinkDefinition(
			...
			0x4aa7c8,
			List.of("kaleidoscope_world_liquor")
		),
		new CGTDrinkDefinition(
